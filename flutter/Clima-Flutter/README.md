...
_Note from Nick:_ You will need to replace the api key with your own in order to get this to run. You will also need to [enable geolocation](https://pub.dev/packages/geolocator#usage).
